...
export default function Home() {
  ...
  Home = {};
  Home.window = window; // Set window property
  Home.onscroll = function() {
      jet(); // Call the jet function
  };
  ...
  return (
    <div classNameName="App">
       <center><h2>RRonerous Interiors</h2>
...
<div id="fourth" className="reveal">
    ...
    <img src= {services} width={1020} height={500}/>
    <br></br>
    <div id="fourth_cards">
        <div>
            <img
...
<div id="fifth" className="reveal">
    ...
    <div>
        <a href="#">
            ...
            <span>
                <h3>Address</h3>
                <p>2-32, Nizampet Rd, Jai Bharat Nagar, Hyder Nagar, Nagarjuna Homes, Kukatpally, Hyderabad, Telengana-500085</p>
            </span>
        </a>
        <a href="#">
            <img
